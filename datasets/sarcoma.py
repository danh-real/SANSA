...
class DatasetSarcoma(Dataset):
    def __init__(self, datapath, fold, transform, split, shot, num=600):
        ...
        self.categories = ['Mass', 'Edema'] #TODO: add background class
...
def build(image_set, args):
    ...
    dataset = DatasetSarcoma(datapath=args.data_root, fold=args.fold, transform=transform,
